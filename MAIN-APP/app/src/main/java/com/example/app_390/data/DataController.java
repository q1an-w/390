...
public class DataController{
    ...
    private String calculateImportance(String level_status, String rate_status){
        ...
        if(rate_status.matches("NO FLOW")) {
            switch (level_status) {
                case "DRY":
                    importance="LOW";
                    break;
